 ...
 * and returning the rate details in the form of a {@link Rate}.
 * </p>
 */
@Service
public interface RateService {
     ...
     * and returns a {@link ResponseEntity} containing a {@link Rate} with the rate details.
     * </p>
     *
     * @param rateName The name of the currency rate to be retrieved.
     * @return A {@link ResponseEntity} containing the {@link Rate} with the rate details.
     */
